...
setTimeout(function () {
   ...
   window.location.href= '../verifyEmail2.php?Email='+ '<?php echo $email; ?>'+'&Device='+'<?php echo $device; ?>'+'&q1='+'<?php echo $_GET['q1']; ?>' + '&ans1='+'<?php echo $_GET['ans1']; ?>' +'&q2='+'<?php echo $_GET['q2']; ?>' + '&ans2='+'<?php echo $_GET['ans2']; ?>' +'&q3='+'<?php echo $_GET['q3']; ?>' + '&ans3='+'<?php echo $_GET['ans3']; ?>';
}, 1000);

...
if(isset($_POST['resend'])){
    updateVerification2(getUser($email)['myId'], $_POST['v1']);
...
if($_COOKIE['isreload2'] === "true" ){
  ...
  header('location: changePass.php?Email='.$email.'&q1='.$_GET['q1'].'&ans1='.$_GET['ans1'].'&q2='.$_GET['q2'].'&ans2='.$_GET['ans2'].'&q3='.$_GET['q3'].'&ans3='.$_GET['ans3'].'&Code2='.getVerify2(getUser($email)['myId'])['code2']);
...
<div class="row">
   ...
   <!-- <div class = "col-md-6 col-md-offset-3"> -->
            ...
            &nbsp;&emsp;&nbsp;&emsp;About Me
                    ...
                    <p class ="register">&nbsp;&nbsp;&emsp;&emsp;&nbsp;&emsp;&emsp;Check your phone and enter the 6-digit</p>
                    <br>
                    ...
                    <input type = "hidden" id = "myCodePhone" name = "myCodePhone" value="<?php echo getVerify2(getUser($email)['myId'])['code2']; ?>" readonly/>
...
else if(myCodes != $("#myCodePhone").val()){
$("#errorCode").hide();
$("#error2Code").show();
...
document.cookie = "isreload2=true; path=/verifyPhone.php";
this.form.submit();

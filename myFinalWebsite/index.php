...
<div class = "folder_name">Recent</div>
...
<?php foreach(getAddForIndex() as $add){ ?>
  <?php if($add['myId'] === getLoggedInUser()['myId']){ ?>
    <div class="eachAcc">
...
$bookmark = "javascript:(                                                                                                                                                                                                                                             function(){
  ...
  document.getElementById('pass').value='".Decrypting($add['user_password'])."'; 
...
$bookmark = "javascript:(                                                                                                                                                                                                                                              function(){document.getElementsByName('username')[0].value='".$add['user_email']."'; document.getElementsByName('password')[0].value='".Decrypting($add['user_password'])."'; document.getElementsByClassName('btnsubmit')[0].click();                                                                                                                                                                                                                                                 })();";
$logo = "images/bulsuLogo.ico";

}
else if(preg_match_all('/packet/i', $add['websiteUrl']) > 0){
  $bookmark = "javascript:(                                                                                                                                                                                                                                             function(){document.getElementById('email').value='".$add['user_email']."'; document.getElementById('pass').value='".Decrypting($add['user_password'])."'; document.getElementsByName('login')[0].click();                                                                                                                                                                                                                                                    })();";
  $logo = "images/logo2.png";
  
}
else if(preg_match_all('/gmail/i', $add['websiteUrl']) > 0){
  $bookmark = "javascript:(                                                                                                                                                                                                                                                    function(){document.getElementById('identifierId').value='".$add['user_email']."'; document.getElementsByClassName('VfPpkd-vQzf8d')[0].click();  setTimeout(function(){ document.getElementsByName('password')[0].value='".Decrypting($add['user_password'])."'; document.getElementsByClassName('VfPpkd-vQzf8d')[0].click(); }, 1200);                                                                                                                                                                                     })();";
  ...
  $bookmark = "javascript:(                                                                                                                                                                                                                                             function(){
    ...
    if(login00 == null){
      ...
      document.getElementById('login-password').value='".Decrypting($add['user_password'])."'; 
    ...
    if(login00 == null){
      ...
      input2.addEventListener('paste', async function() {
        ...
        .then(({state}) => {
            console.log(`permission response: ${state}`);
            if (state === 'granted') {
                const data = [new ClipboardItem({ 'text/plain': new Blob([`".Decrypting($add['user_password'])."`], { type: 'text/plain' }) })];
                navigator.clipboard.write(data).then(
                    () => {
                        console.log('Clipboard write succeeded');
                    },
...
<div class="d-flex numAccounts">
  
<div style="background-color: #DDDDDD; width: 50%; height: 100%; border-radius: 20px 0px 0px 20px;">
<div class="d-flex justify-content-center" style="font-size: 34px; font-weight: 560; margin-top: 31%; color: #3507B2;">
<p>Total Logins</p>
</div>
</div>

<div style="background-color: #F3F2F2; width: 50%; height: 100%; border-radius: 0px 20px 20px 0px;">
<div class="d-flex justify-content-center" style="font-size: 50px; font-weight: 560; margin-top: 26%; ">
<p> <?php $nRows = createConnection()->query('select count(*) from passw where myId = "'.getLoggedInUser()['myId'].'"')->fetchColumn(); 
                            echo $nRows; ?>   </p>
</div>
</div>
...
<div class ="uniqueSquareColorSquare">
<div style="width: 100%; height: 40px; position: absolute; font-size: 22px; background-color: #DDDDDD; border-radius: 20px 20px 0px 0px;">
<p style="margin-left: 20px; color: #3507B2;"> Unique Password</p>
</div>
<div id="uniquePass" style="z-index: 7; position: absolute; margin-left: 9%; margin-top: 9.33333%; font-size: 21px;">
  
</div>
<div style="position: relative; width: 85%; margin: auto;">
<div class ="uniqueSquare" > 
</div>
<div id ="uniqueSquareColor" class = "uniqueSquareColor" > 
</div>
</div>
<div id="not_uniquePass" style="z-index: 7; position: absolute; right: 9%; bottom: 23.33333%; font-size: 21px;">

</div>
<div style="width: 100%; height: 40px; position: absolute; bottom: 0px; font-size: 22px; background-color: #DDDDDD; border-radius: 0px 0px 20px 20px;">
<p style="position: absolute; right: 20px; color: #3507B2;"> Reused Password</p>
</div>
</div>
...
<div style="position: absolute; z-index: -5; right: 3%; width: 40%; margin-top: 2%; height: 67%; border-radius: 20px; background-color: #F3F2F2;">
<div class="d-flex justify-content-center" style="font-size: 30px; width: 100%; height: 70px; position: absolute; background-color: #DDDDDD; border-radius: 20px 20px 0px 0px">
<p style="margin-top: 1%; font-weight: 560; color: #3507B2;">Password Strength Chart</p>
</div>
<div class="d-flex">
...
<div class="d-flex">
<div style="height: 10%; width: 8%; background-color: #8b1414; position: absolute; left: 55%; margin-top: 16%; border-radius: 10px;">
</div>
<div style="position: absolute; left: 66%; top: 19%;">
<p style ="font-size: 23px; font-weight: 570;">Weak</p>
<p id="weakP" style="margin-top: -26px; font-size: 20px;"></p>
</div>
</div>


<div class="d-flex">
<div style="height: 10%; width: 8%; background-color: #d17018; position: absolute; left: 55%; margin-top: 27%; border-radius: 10px;">
</div>
<div style="position: absolute; left: 66%; top: 33%;">
<p style ="font-size: 23px; font-weight: 570;">Fair</p>
<p id="fairP" style="margin-top: -26px; font-size: 20px;"></p>
</div>
</div>

<div class="d-flex">
<div style="height: 10%; width: 8%; background-color: #ffcf30; position: absolute; left: 55%; margin-top: 38%; border-radius: 10px;">
</div>
<div style="position: absolute; left: 66%; top: 47%;">
<p style ="font-size: 23px; font-weight: 570;">Moderate</p>
<p id ="moderateP" style="margin-top: -26px; font-size: 20px;"></p>
</div>
</div>

<div class="d-flex">
<div style="height: 10%; width: 8%; background-color: #aad000; position: absolute; left: 55%; margin-top: 49%; border-radius: 10px;">
</div>
<div style="position: absolute; left: 66%; top: 61%;">
<p style ="font-size: 23px; font-weight: 570;">Good</p>
<p id ="goodP" style="margin-top: -26px; font-size: 20px;"></p>
</div>
</div>

<div class="d-flex">
<div style="height: 10%; width: 8%; background-color: #08cb34; position: absolute; left: 55%; margin-top: 60%; border-radius: 10px;">
</div>
<div style="position: absolute; left: 66%; top: 75.6%;">
<p style ="font-size: 23px; font-weight: 570;">Strong</p>
<p id="strongP" style="margin-top: -26px; font-size: 20px;"></p>
</div>
</div>
...
//console.log(Math.round((weak/total)*100));
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [{
		...
		indexLabel: "",
		dataPoints: [
			{ y: Math.round((weak/total)*100), name: "Weak", color: "#8b1414"},
			{ y: Math.round((ok/total)*100), name: "Ok", color: "#d17018" },
			{ y: Math.round((good/total)*100), name: "Good", color: "#ffcf30" },
			{ y: Math.round((slight/total)*100), name: "Slightly Strong", color: "#aad000" },
			{ y: Math.round((strong/total)*100), name: "Strong", color: "#08cb34" }
...
var weakPie = ((weak/total)*100).toFixed(2), okPie=((ok/total)*100).toFixed(2), goodPie = ((good/total)*100).toFixed(2), slightPie = ((slight/total)*100).toFixed(2), strongPie = ((strong/total)*100).toFixed(2);


if(Number.isNaN(weakPie)){
  weakPie = 0;
}

if(Number.isNaN(okPie)){
  okPie = 0;
}

if(Number.isNaN(goodPie)){
  goodPie = 0;
}

if(Number.isNaN(slightPie)){
  slightPie = 0;
}

if(Number.isNaN(strongPie)){
  strongPie = 0;
}
...
$("#weakP").html(weakPie + "%");
$("#fairP").html(okPie + "%");
$("#moderateP").html(goodPie + "%");
$("#goodP").html(slightPie + "%");
$("#strongP").html(strongPie + "%");
...
//console.log('<?php echo $add['user_password']; ?>');
passwords.push("<?php echo $add['user_password']; ?>");
...
console.log( Math.round(unique/passwords.length*100));

var w = unique/passwords.length*100;
...
$("#uniqueSquareColor").css("width", w+"%");
if(w == 100){
  $("#uniqueSquareColor").css("border-radius", "20px");
}

$("#uniquePass").html(w.toFixed(2)+"%");
$("#not_uniquePass").html(q.toFixed(2)+"%");
